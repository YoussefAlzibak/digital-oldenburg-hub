...
import { ArrowRight, Globe, Users, Award, Target, Heart, Lightbulb, Shield, Zap } from "lucide-react";
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/about" className="text-sm font-medium text-primary">Über uns</Link>
