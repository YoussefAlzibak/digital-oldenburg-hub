-- Create cron job to process scheduled campaigns
-- This will check every minute for campaigns that should be sent
...
SELECT cron.schedule(
  ...
  SELECT
    net.http_post(
        url:='https://kgwanyretbrxwtwduljg.supabase.co/functions/v1/process-scheduled-campaigns',
